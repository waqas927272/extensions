(() => {
    ...
    // Get the specific hospital name before falling back to parent/group names.
    let hospitalName = getHospitalFromTitle(positionTitle) ||
        findHospitalInDescription(fullDescription) ||
        cleanHospitalNameCandidate(domData.hospitalName) ||
        cleanHospitalNameCandidate(jsonLd?.hiringOrganization?.name) ||
        '';
